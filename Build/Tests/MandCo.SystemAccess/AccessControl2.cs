...
namespace MandCo.SystemAccess
{
    ...
    /// <summary>Access Control(P#61)</summary>
    // Last change before Migration: 30/12/2013 11:24:03
    internal class AccessControl2 : BusinessProcessBase 
    {
        ...
        /// <summary>AccessScreen(P#61.1)</summary>
        // Last change before Migration: 30/12/2013 11:24:03
        internal class AccessScreen : UIControllerBase 
        {
            ...
            AccessControl2 _parent;
            
            
            /// <summary>AccessScreen(P#61.1)</summary>
            public AccessScreen(AccessControl2 parent)
            {
                _parent = parent;
                Title = "AccessScreen";
                InitializeDataView();
            ...
            protected override void OnLoad()
            {
                ...
                AllowUpdate = false;
                AllowSelect = true;
                View = ()=> new Views.AccessControl2SystemAccess(this);
            }
            protected override void OnEnd()
            {
            ...
            /// <summary>UsersAccessControl(P#61.1.1)</summary>
            ...
            internal class UsersAccessControl : BusinessProcessBase 
            {
                ...
                /// <summary>KillActiveUsers(P#61.1.1.1)</summary>
                // Last change before Migration: 31/05/2004 16:23:26
                internal class KillActiveUsers : BusinessProcessBase 
                {
                    ...
                    Printing.AccessControl2KillActiveUsers _layout;
                    #endregion
                    ...
                    public KillActiveUsers()
                    {
                        ...
                        #endregion
                        _layout = new Printing.AccessControl2KillActiveUsers(this);
                    }
                    void InitializeDataView()
                    {
                        Relations.Add(Users, 
        ...
        /// <summary>DeleteAccessList(P#61.2)</summary>
        ...
        /// <summary>CreateAccessList(P#61.3)</summary>
        ...
        class CreateAccessList : BusinessProcessBase 
        {
            ...
            /// <summary>CreateAccessList(P#61.3)</summary>
            public CreateAccessList(AccessControl2 parent)
            {
                _parent = parent;
        ...
        /// <summary>Users DisAllowed(P#61.4)</summary>
        ...
        internal class UsersDisAllowed : BusinessProcessBase 
        {
            ...
            protected override void OnLoad()
            {
                ...
                if(NewViewRequired)
                {
                    View = ()=> new Views.AccessControl2UsersDisAllowed(this);
                }
            }
            protected override void OnStart()
            {
