...
namespace MandCo.SystemAccess
{
    ...
    /// <summary>Access Control ORIGINAL(P#60)</summary>
    // Last change before Migration: 21/12/2010 09:28:01
    internal class AccessControlORIGINAL : BusinessProcessBase 
    {
        ...
        /// <summary>Access Control ORIGINAL(P#60)</summary>
        public AccessControlORIGINAL()
        {
            Title = "Access Control ORIGINAL";
            InitializeDataView();
        }
        ...
        /// <summary>AccessScreen(P#60.1)</summary>
        // Last change before Migration: 16/07/2007 16:19:16
        internal class AccessScreen : FlowUIControllerBase 
        {
            ...
            AccessControlORIGINAL _parent;
            
            
            /// <summary>AccessScreen(P#60.1)</summary>
            public AccessScreen(AccessControlORIGINAL parent)
            {
                _parent = parent;
                Title = "AccessScreen";
            ...
            protected override void OnLoad()
            {
                ...
                AllowUpdate = false;
                AllowSelect = true;
                View = ()=> new Views.AccessControlORIGINALSystemAccess(this);
            }
            protected override void OnEnd()
            {
            ...
            /// <summary>OpenApplication(P#60.1.1)</summary>
            // Last change before Migration: 16/07/2007 16:19:16
            class OpenApplication : BusinessProcessBase 
            {
                ...
                /// <summary>GoTopApplications(P#60.1.1.1)</summary>
            ...
            /// <summary>UsersAccessControl(P#60.1.2)</summary>
            ...
            internal class UsersAccessControl : BusinessProcessBase 
            {
                ...
                /// <summary>KillActiveUsers(P#60.1.2.1)</summary>
                // Last change before Migration: 31/05/2004 16:23:26
                internal class KillActiveUsers : BusinessProcessBase 
                {
                    ...
                    Printing.AccessControlORIGINALKillActiveUsers _layout;
                    #endregion
                    ...
                    public KillActiveUsers()
                    {
                        ...
                        #endregion
                        _layout = new Printing.AccessControlORIGINALKillActiveUsers(this);
                    }
                    void InitializeDataView()
                    {
                        Relations.Add(Users, 
        ...
        /// <summary>DeleteAccessList(P#60.2)</summary>
        ...
        /// <summary>CreateAccessList(P#60.3)</summary>
        ...
        class CreateAccessList : BusinessProcessBase 
        {
            ...
            /// <summary>CreateAccessList(P#60.3)</summary>
            public CreateAccessList(AccessControlORIGINAL parent)
            {
                _parent = parent;
        ...
        /// <summary>Users DisAllowed(P#60.4)</summary>
        ...
        internal class UsersDisAllowed : BusinessProcessBase 
        {
            ...
            protected override void OnLoad()
            {
                ...
                if(NewViewRequired)
                {
                    View = ()=> new Views.AccessControlORIGINALUsersDisAllowed(this);
                }
            }
            protected override void OnStart()
            {
