...
namespace MandCo.SystemAccess
{
    ...
    /// <summary>Maint - Users (dv)(P#52)</summary>
    // Last change before Migration: 13/01/2004 12:58:21
    internal class MaintUsersDv : FlowUIControllerBase 
    {
        ...
        protected override void OnLoad()
        {
            ...
            View = ()=> new Views.MaintUsersDvUsers(this);
        }
        ...
        // Last change before Migration: 13/01/2004 11:46:58
        internal class EmailAddresses : UIControllerBase 
        {
            ...
            MaintUsersDv _parent;
            
            
            /// <summary>Email Addresses(P#52.1)</summary>
            public EmailAddresses(MaintUsersDv parent)
            {
                _parent = parent;
            ...
            protected override void OnLoad()
            {
                ...
                if(NewViewRequired)
                {
                    View = ()=> new Views.MaintUsersDvEmailAddresses(this);
                }
            }
            ...
            /// <summary>Get High Seq No(P#52.1.1)</summary>
        ...
        /// <summary>Delete Children(P#52.2)</summary>
        ...
        class DeleteChildren : BusinessProcessBase 
        {
            ...
            /// <summary>Delete Children(P#52.2)</summary>
            public DeleteChildren(MaintUsersDv parent)
            {
                _parent = parent;
