...
namespace MandCo.SystemAccess.Views
{
    ...
    partial class MaintUsersEmailAddresses : MandCo.Theme.Controls.Form 
    {
        MaintUsers.EmailAddresses _controller;
        
        
        /// <summary>Email Addresses(P#5.1)</summary>
        internal MaintUsersEmailAddresses(MaintUsers.EmailAddresses controller)
        {
