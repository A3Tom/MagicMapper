...
{
    partial class MaintUsersDvUsers
    {
        ...
        void InitializeComponent()
        {
            ...
            this.txtUsersUserID.ReadOnly = true;
            this.txtUsersUserID.Size = new System.Drawing.Size(73, 16);
            this.txtUsersUserID.Style = Firefly.Box.UI.ControlStyle.Flat;
            this.txtUsersUserID.BindReadOnly += new Firefly.Box.UI.Advanced.BindingEventHandler<Firefly.Box.UI.Advanced.BooleanBindingEventArgs>(this.txtUsersUserID_BindReadOnly);
            this.txtUsersUserID.BindColorScheme += new Firefly.Box.UI.Advanced.BindingEventHandler<Firefly.Box.UI.Advanced.ColorSchemeBindingEventArgs>(this.Exp_2_BindColorScheme);
            ...
            this.txtUsersUserName.BindColorScheme += new Firefly.Box.UI.Advanced.BindingEventHandler<Firefly.Box.UI.Advanced.ColorSchemeBindingEventArgs>(this.Exp_2_BindColorScheme);
