...
namespace MandCo.SystemAccess.Views
{
    ...
    partial class AccessControlDVSystemAccess : MandCo.Theme.Controls.Form 
    {
        AccessControlDV.AccessScreen _controller;
        
        
        /// <summary>AccessScreen(P#59.1)</summary>
        internal AccessControlDVSystemAccess(AccessControlDV.AccessScreen controller)
        {
