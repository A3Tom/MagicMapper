...
namespace MandCo.SystemAccess.Views
{
    ...
    partial class AccessControl2SystemAccess : MandCo.Theme.Controls.Form 
    {
        AccessControl2.AccessScreen _controller;
        
        
        /// <summary>AccessScreen(P#61.1)</summary>
        internal AccessControl2SystemAccess(AccessControl2.AccessScreen controller)
        {
