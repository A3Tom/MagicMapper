...
namespace MandCo.SystemAccess.Views
{
    ...
    partial class AccessControlPvJuly07SystemAccess : MandCo.Theme.Controls.Form 
    {
        AccessControlPvJuly07.AccessScreen _controller;
        
        
        /// <summary>AccessScreen(P#45.1)</summary>
        internal AccessControlPvJuly07SystemAccess(AccessControlPvJuly07.AccessScreen controller)
        {
        ...
        void Exp_15_BindVisible(object sender, BooleanBindingEventArgs e)
        {
            e.Value = _controller.Exp_15();
        }
        void txtVUserAccessMessage_BindColorScheme(object sender, ColorSchemeBindingEventArgs e)
        {
            e.Value = MandCo.Theme.Colors.Map.Find(_controller.Exp_4());
        }
