...
namespace MandCo.SystemAccess.Views
{
    partial class MaintUsersUsers
    {
        ...
        void InitializeComponent()
        {
            ...
            this.txtUsersUserID.BindColorScheme += new Firefly.Box.UI.Advanced.BindingEventHandler<Firefly.Box.UI.Advanced.ColorSchemeBindingEventArgs>(this.Exp_4_BindColorScheme);
            ...
            this.txtUsersUserName.BindColorScheme += new Firefly.Box.UI.Advanced.BindingEventHandler<Firefly.Box.UI.Advanced.ColorSchemeBindingEventArgs>(this.Exp_4_BindColorScheme);
