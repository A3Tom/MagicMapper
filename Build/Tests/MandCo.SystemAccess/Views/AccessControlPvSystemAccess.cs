...
namespace MandCo.SystemAccess.Views
{
    ...
    partial class AccessControlPvSystemAccess : MandCo.Theme.Controls.Form 
    {
        AccessControlPv.AccessScreen _controller;
        
        
        /// <summary>AccessScreen(P#46.1)</summary>
        internal AccessControlPvSystemAccess(AccessControlPv.AccessScreen controller)
        {
