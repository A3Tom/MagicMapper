...
namespace MandCo.SystemAccess
{
    ...
    /// <summary>Access Control(dvAP)(P#51)</summary>
    // Last change before Migration: 16/07/2007 16:09:25
    internal class AccessControlDvAP : BusinessProcessBase 
    {
        ...
        /// <summary>Access Control(dvAP)(P#51)</summary>
        public AccessControlDvAP()
        {
            Title = "Access Control(dvAP)";
            InitializeDataView();
        }
        ...
        /// <summary>AccessScreen(P#51.1)</summary>
        // Last change before Migration: 16/07/2007 16:09:25
        internal class AccessScreen : FlowUIControllerBase 
        {
            ...
            AccessControlDvAP _parent;
            
            
            /// <summary>AccessScreen(P#51.1)</summary>
            public AccessScreen(AccessControlDvAP parent)
            {
                _parent = parent;
                Title = "AccessScreen";
            ...
            protected override void OnLoad()
            {
                ...
                AllowUpdate = false;
                AllowSelect = true;
                View = ()=> new Views.AccessControlDvAPSystemAccess(this);
            }
            protected override void OnEnd()
            {
            ...
            /// <summary>OpenApplication(P#51.1.1)</summary>
            ...
            class OpenApplication : BusinessProcessBase 
            {
                ...
                /// <summary>GoTopApplications(P#51.1.1.1)</summary>
            ...
            /// <summary>UsersAccessControl(P#51.1.2)</summary>
            // Last change before Migration: 16/07/2007 16:09:25
            internal class UsersAccessControl : BusinessProcessBase 
            {
                ...
                /// <summary>KillActiveUsers(P#51.1.2.1)</summary>
                // Last change before Migration: 16/07/2007 16:09:25
                internal class KillActiveUsers : BusinessProcessBase 
                {
                    ...
                    Printing.AccessControlDvAPKillActiveUsers _layout;
                    #endregion
                    ...
                    public KillActiveUsers()
                    {
                        ...
                        #endregion
                        _layout = new Printing.AccessControlDvAPKillActiveUsers(this);
                    }
                    void InitializeDataView()
                    {
                        Relations.Add(Users, 
        ...
        /// <summary>DeleteAccessList(P#51.2)</summary>
        ...
        /// <summary>CreateAccessList(P#51.3)</summary>
        ...
        class CreateAccessList : BusinessProcessBase 
        {
            ...
            /// <summary>CreateAccessList(P#51.3)</summary>
            public CreateAccessList(AccessControlDvAP parent)
            {
                _parent = parent;
        ...
        /// <summary>Users DisAllowed(P#51.4)</summary>
        ...
        internal class UsersDisAllowed : BusinessProcessBase 
        {
            ...
            protected override void OnLoad()
            {
                ...
                if(NewViewRequired)
                {
                    View = ()=> new Views.AccessControlDvAPUsersDisAllowed(this);
                }
            }
            protected override void OnStart()
            {
