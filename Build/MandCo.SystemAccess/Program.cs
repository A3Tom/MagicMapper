    ...
    class Program
    {
        ...
        public static void Main(System.String[] args)
        {
            try
            {
                ...
                ENV.Data.DataProvider.OracleHelper.UseOracleODPClient();
                
                ENV.Data.DateColumn.GlobalDefault = new Date(1901,1,1);
                ENV.Commands.SetDefaultKeyboardMapping();
                ENV.Common.ApplicationTitle = "MandCo.SystemAccess";
                ENV.UserSettings.FixedBackColorInNonFlatStyles = true;
                ENV.UserSettings.InitUserSettings("MandCo.SystemAccess.ini", args);
                if(ENV.UserSettings.DoNotDisplayUI)
                {
                    ENV.Common.IncludeProcessAndThreadInTraceFileName = true;
                }
                // 
                // 
                Application.Run();
