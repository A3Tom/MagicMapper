...
namespace MandCo.SystemAccess
{
    ...
    /// <summary>Access Control  DV(P#59)</summary>
    // Last change before Migration: 21/12/2010 09:29:20
    internal class AccessControlDV : BusinessProcessBase 
    {
        ...
        /// <summary>Access Control  DV(P#59)</summary>
        public AccessControlDV()
        {
            Title = "Access Control  DV";
            InitializeDataView();
        }
        ...
        /// <summary>Access Control  DV</summary>
        public void Run()
        {
            Execute();
        }
        ...
        /// <summary>AccessScreen(P#59.1)</summary>
        // Last change before Migration: 20/12/2010 16:29:05
        internal class AccessScreen : UIControllerBase 
        {
            ...
            AccessControlDV _parent;
            
            
            /// <summary>AccessScreen(P#59.1)</summary>
            public AccessScreen(AccessControlDV parent)
            {
                _parent = parent;
                Title = "AccessScreen";
                InitializeDataView();
            ...
            void InitializeDataView()
            {
                ...
                Columns.Add(Applications.ApplicationID);
            ...
            protected override void OnLoad()
            {
                ...
                AllowUpdate = false;
                AllowSelect = true;
                View = ()=> new Views.AccessControlDVSystemAccess(this);
            }
            protected override void OnEnd()
            {
            ...
            void StartApplicationOfChoiceHandler(HandlerInvokeEventArgs e)
            {
                if(false)
                {
                    Message.ShowWarning(Exp_15());
                }
                Raise(Commands.RestartApplication, Exp_15());
                e.Handled = true;
            }
            #endregion
            ...
            Text Exp_15()
            {
                return "%UnipaasApps%" + u.Trim(Applications.ApplicationID) + @"\ecf\" + u.Trim(Applications.ApplicationID) + ".ecf";
            }
            #endregion
            
            
            
            /// <summary>UsersAccessControl(P#59.1.1)</summary>
            ...
            internal class UsersAccessControl : BusinessProcessBase 
            {
                ...
                /// <summary>KillActiveUsers(P#59.1.1.1)</summary>
                // Last change before Migration: 31/05/2004 16:23:26
                internal class KillActiveUsers : BusinessProcessBase 
                {
                    ...
                    Printing.AccessControlDVKillActiveUsers _layout;
                    #endregion
                    ...
                    public KillActiveUsers()
                    {
                        ...
                        #endregion
                        _layout = new Printing.AccessControlDVKillActiveUsers(this);
                    }
                    void InitializeDataView()
                    {
                        Relations.Add(Users, 
        ...
        /// <summary>DeleteAccessList(P#59.2)</summary>
        ...
        /// <summary>CreateAccessList(P#59.3)</summary>
        // Last change before Migration: 20/12/2010 16:26:56
        class CreateAccessList : BusinessProcessBase 
        {
            ...
            /// <summary>CreateAccessList(P#59.3)</summary>
            public CreateAccessList(AccessControlDV parent)
            {
                _parent = parent;
        ...
        /// <summary>Users DisAllowed(P#59.4)</summary>
        ...
        internal class UsersDisAllowed : BusinessProcessBase 
        {
            ...
            protected override void OnLoad()
            {
                ...
                if(NewViewRequired)
                {
                    View = ()=> new Views.AccessControlDVUsersDisAllowed(this);
                }
            }
            protected override void OnStart()
            {
