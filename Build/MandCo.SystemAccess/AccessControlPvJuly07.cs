...
namespace MandCo.SystemAccess
{
    ...
    /// <summary>Access Control(pv July07)(P#45)</summary>
    // Last change before Migration: 02/08/2004 16:07:39
    internal class AccessControlPvJuly07 : BusinessProcessBase 
    {
        ...
        /// <summary>Access Control(pv July07)(P#45)</summary>
        public AccessControlPvJuly07()
        {
            Title = "Access Control(pv July07)";
            InitializeDataView();
        }
        ...
        /// <summary>AccessScreen(P#45.1)</summary>
        ...
        internal class AccessScreen : FlowUIControllerBase 
        {
            ...
            AccessControlPvJuly07 _parent;
            
            
            /// <summary>AccessScreen(P#45.1)</summary>
            public AccessScreen(AccessControlPvJuly07 parent)
            {
                _parent = parent;
                Title = "AccessScreen";
            ...
            protected override void OnLoad()
            {
                ...
                AllowUpdate = false;
                AllowSelect = true;
                View = ()=> new Views.AccessControlPvJuly07SystemAccess(this);
            }
            protected override void OnEnd()
            {
            ...
            /// <summary>OpenApplication(P#45.1.1)</summary>
            ...
            class OpenApplication : BusinessProcessBase 
            {
                ...
                /// <summary>GoTopApplications(P#45.1.1.1)</summary>
            ...
            /// <summary>UsersAccessControl(P#45.1.2)</summary>
            // Last change before Migration: 31/05/2004 16:23:26
            internal class UsersAccessControl : BusinessProcessBase 
            {
                ...
                /// <summary>KillActiveUsers(P#45.1.2.1)</summary>
                // Last change before Migration: 31/05/2004 16:23:26
                internal class KillActiveUsers : BusinessProcessBase 
                {
                    ...
                    Printing.AccessControlPvJuly07KillActiveUsers _layout;
                    #endregion
                    ...
                    public KillActiveUsers()
                    {
                        ...
                        #endregion
                        _layout = new Printing.AccessControlPvJuly07KillActiveUsers(this);
                    }
                    void InitializeDataView()
                    {
                        Relations.Add(Users, 
        ...
        /// <summary>DeleteAccessList(P#45.2)</summary>
        ...
        /// <summary>CreateAccessList(P#45.3)</summary>
        ...
        class CreateAccessList : BusinessProcessBase 
        {
            ...
            /// <summary>CreateAccessList(P#45.3)</summary>
            public CreateAccessList(AccessControlPvJuly07 parent)
            {
                _parent = parent;
        ...
        internal class UsersDisAllowed : BusinessProcessBase 
        {
            ...
            protected override void OnLoad()
            {
                ...
                if(NewViewRequired)
                {
                    View = ()=> new Views.AccessControlPvJuly07UsersDisAllowed(this);
                }
            }
            protected override void OnStart()
            {
